...
export default new sdk.IntegrationDefinition({
  ...
  .extend(creatable, ({ entities }) => ({
    ...
    actions: {
      create: { name: 'cardCreate' },
    },
    events: {
      created: { name: 'cardCreated' },
    },
  }))
  .extend(updatable, ({ entities }) => ({
    ...
    actions: {
      update: { name: 'cardUpdate' },
    },
    events: {
      updated: { name: 'cardUpdated' },
    },
  }))
  .extend(deletable, ({ entities }) => ({
    ...
    actions: {
      delete: { name: 'cardDelete' },
    },
    events: {
      deleted: { name: 'cardDeleted' },
    },
  }))
  .extend(listable, ({ entities }) => ({
    entities: {
